...
json.meta do
  json.sender do
    json.partial! 'api/v1/models/contact', formats: [:json], resource: conversation.contact if conversation.contact
  end
...
json.whatsapp_window_expires_at conversation.whatsapp_window_expires_at&.to_i
