...
import WhatsAppCampaignRecipientsPage from './pages/WhatsAppCampaignRecipientsPage.vue';
import WhatsAppCampaignAnalyticsPage from './pages/WhatsAppCampaignAnalyticsPage.vue';
import { FEATURE_FLAGS } from 'dashboard/featureFlags';

const meta = {
  featureFlag: FEATURE_FLAGS.CAMPAIGNS,
  permissions: ['administrator', 'campaign_view', 'campaign_manage'],
};
  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: WhatsAppCampaignRecipientsPage,
        },
        {
