class Whatsapp::WebhookSetupService
  ...
  # URL genérica compartida por todos los números (feature WhatsApp multi-número): NO usar la
  # variante con phone_number en la ruta, ya en producción con esta URL registrada en Meta.
